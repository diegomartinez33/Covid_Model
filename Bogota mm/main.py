...
infectados_iniciales = 0.95 #porcentaje de infectados iniciales
porcentaje_agentes = 0.001 #porcentaje de agentes con respecto a la estimación
...
poblacion = 7715778 #población de la ciudad
area = 1636 #área de la ciudad
n_corridas = 90 #número de corridas del modelo
