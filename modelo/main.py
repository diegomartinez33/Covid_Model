...
#rutas datos
ruta_datos_censo = "C:/Users/af.useche10/Dropbox (Uniandes)/COVID_19_MODEL/Datos/insumos_modeloabm/barranquilla/datos_censo_vf.xlsx"
ruta_datos_movilidad = "C:/Users/af.useche10/Dropbox (Uniandes)/COVID_19_MODEL/Datos/insumos_modeloabm/barranquilla/datos_movilidad_vf.xlsx"

#parámetros del modelo
m = 250 #tamaño de la grilla
infectados_iniciales = 0.99 #porcentaje de infectados iniciales
porcentaje_agentes = 0.01 #porcentaje de agentes con respecto a la estimación
...
poblacion = 1243113 #población de la ciudad
area = 154 #área de la ciudad
...
activación_cuarentena_acordeon = False #parámetro para activar la cuarentena por acordeon después de la cuarentena regular
...
modalidad_cuarentena = ("smpl" if activación_cuarentena_acordeon == False else "acdn")
data.to_csv('{}_{}_{}_{}.csv'.format(dias_cuarentena,modalidad_cuarentena,modalidad,city ,pruebas_disponibles))
#data.to_csv('pb.csv')