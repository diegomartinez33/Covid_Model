...
#Matrices para la actualización de la movilidad
MATRIZ_MOVILIDAD2 = 0
MATRIZ_MOVILIDAD3 = 0
ACUMULADA_MOVILIDAD2 = 0
ACUMULADA_MOVILIDAD3 = 0
...
class ciudad(Model):
    ...
    def __init__(self,n,m,width,height,porcentaje_infectados, densidad, acumedad,sexo, edades, transporte, Casillas_zona, acummovilidad, movilidad,acummovilidad2,movilidad2,acummovilidad3,movilidad3,dias_cuarentena,long_paso, porcentaje_en_cuarentena, 
    ...
    def actualizar_movilidad(self):
        ...
        if t == 35:
            for i in agentes:
                i.set_posf(ACUMULADA_MOVILIDAD2,MATRIZ_MOVILIDAD2,MATRIZ_CASILLAS)
                #print(i.unique_id," Estado:",i.estado, " zona_origen:",i.zona," zona_destino:",i.zona_destino)
        if t == 49:
            for i in agentes:
                i.set_posf(ACUMULADA_MOVILIDAD3,MATRIZ_MOVILIDAD3,MATRIZ_CASILLAS)
                #print(i.unique_id," Estado:",i.estado, " zona_origen:",i.zona," zona_destino:",i.zona_destino)
